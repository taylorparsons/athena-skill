...
Decisions: D-20260211-0940, D-20260211-1005, D-20260211-1012, D-20260211-1020, D-20260211-1326, D-20260211-1400, D-20260212-1647, D-20260212-1648, D-20260213-0913, D-20260213-1959, D-20260213-1437, D-20260213-1438, D-20260213-1448, D-20260213-1453, D-20260216-1318, D-20260217-0847, D-20260217-1419, D-20260217-1452, D-20260217-1536, D-20260217-1551, D-20260218-0903, D-20260218-1100
...
- Restore broad commit-helper staging with pre-stage checks that block risky files before staging. (Sources: CR-20260218-1059; D-20260218-1100)
...
- FR-ATHENA-021: Update traceable commit helper defaults to broad staging with pre-stage checks that block `.DS_Store`, temp/cache patterns, likely secret markers, and large artifacts, while retaining scoped staging via `--paths` and `--docs-only`. (Sources: CR-20260218-1059; D-20260218-1100)
...
## Next / backlog
- Implemented in: `scripts/commit_with_traceability.py`, `skills/athena/scripts/commit_with_traceability.py`, `SKILL.md`, `skills/athena/SKILL.md`, `docs/specs/20260218-staging-precheck-guardrails/spec.md`, `docs/specs/20260218-staging-precheck-guardrails/tasks.md`, `docs/progress.txt`.
